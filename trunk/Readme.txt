...
- The folder LinuxCompileTools contains a linux script file to compile and place the executible in bin folder.
- VC6ProjectFiles and VS2010ProjectFiles contain VC6 and VS2010 projects configured to compile and place the output exe into bin folder.
